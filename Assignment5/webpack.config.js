...
module.exports = {
  entry: "./src/Assignment5.ts", //entry point of application
  mode: "development",
  watch: true, //enable to debug (step through)
  module: {
    //details about grabbing modules to export
    rules: [
      {
  ...
  resolve: {
    ...
    alias: {
      //alias to manage relative paths
      "%COMMON": path.resolve(__dirname, "../common") //resolve alias to this relative path
    }
  },
  output: {
    filename: "assignment5.js", //name of the final bundled JS file
    path: path.resolve(__dirname, "out") //put bundled file in this folder
  },
  devtool: "source-map" //enable source-map for debugging (stepping through). generates DrawWithIndices.js.map
};
