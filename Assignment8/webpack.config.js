...
module.exports = {
    entry: './src/Assignment8.ts', //entry point of application
    ...
    output: {
        filename: 'assignment8.js', //name of the final bundled JS file
        path: path.resolve(__dirname, 'out') //put bundled file in this folder
    },
    devtool: 'source-map', //enable source-map for debugging (stepping through). generates RaytracerStart.js.map
};
