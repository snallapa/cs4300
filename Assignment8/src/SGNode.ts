...
export abstract class SGNode {
  ...
  public abstract getLights(modelView: Stack<mat4>);

  public abstract getNumberLights(): number;

  public abstract rayObject(ray: Ray, modelView: Stack<mat4>): HitRecord;

  public abstract draw(
    context: ScenegraphRenderer,
